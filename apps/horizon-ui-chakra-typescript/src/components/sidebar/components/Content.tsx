// chakra imports
import {Box, Button, Center, Flex, Slide, Stack, Text, VStack} from '@chakra-ui/react';
//   Custom components
...
function SidebarContent(props: { routes: RoutesType[] }) {
	...
	return (
		<>
			<SlideError isError={query.isError} message='Failed to Fetch Groups' retry={() => query.refetch()} />
