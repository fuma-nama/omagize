...
function SignIn() {
    ...
    return <DefaultAuth illustrationBackground={illustration}>
        <Flex
            ...
            <Flex
                ...
                <Flex align='center' mb='25px'>
                    ...
                    <VerifyGroup title='Email' error={mutation.isError && "Wrong Email or Password"}>
                        <Input
                            id='email'
                            isRequired={true}
                            variant='auth'
                    ...
                    <VerifyGroup title='Password' error={mutation.isError && "Wrong Email or Password"}>
                        <PasswordInput input={{
