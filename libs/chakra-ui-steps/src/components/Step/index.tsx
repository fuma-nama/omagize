...
export const dataAttr = (condition: boolean | undefined) => (condition ? '' : undefined) as string;
    ...
    >
      ...
      >
        <chakra.div
          ...
          aria-current={(hasVisited && isKeepError) || isCurrentStep ? 'step' : undefined}
          data-invalid={dataAttr(
            ((hasVisited && isKeepError) || isCurrentStep) && (isError || state === 'error')
          )}
