        ...
        <ModalContent>
            ...
            <ModalBody>
                ...
                <FormControl isRequired isInvalid={mutation.isError}>
                    ...
                    <Input value={id} onChange={e => setId(e.target.value)} variant="main" placeholder="XXXXXX" />
                    <FormErrorMessage>{mutation.error?.toString()}</FormErrorMessage>
                    <FormHelperText hidden={mutation.isError}>Friend ID is a 6-length number</FormHelperText>
                </FormControl>
            </ModalBody>
            ...
            <ModalFooter>
                ...
                <Button
                    ...
                    variant='brand' rightIcon={<BiRightArrow />}>Send Friend Request</Button>
            </ModalFooter>
        </ModalContent>
    </Modal>
}