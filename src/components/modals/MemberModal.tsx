...
import {useGroupMembersQuery} from "../../api/GroupAPI";
import {Snowflake} from "../../api/utils/types";
import InfiniteScroll from "react-infinite-scroll-component";
import UserItem from "../card/UserItem";

export default function MemberModal(props: {isOpen: boolean, onClose: () => void, group: Snowflake}) {
    return <Modal
...
function Members({group}: {group: Snowflake}) {
    ...
    return <Flex id='members-div' direction='column'>
        <InfiniteScroll
